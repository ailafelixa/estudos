...
### 6. Sempre tenha claro os riscos e benefícios de suas ideias e ações
Quando queremos investir em algo ou temos que propor uma solução para algum problema, tendemos a nos apegar a solução que escolhemos e tentar mostrar os pontos positivos disso para os tomadores de decisão. Entretanto, é sempre essencial manter os pontos negativos de algo em mente e também comunica-los aos nossos superiores. Isso demonstra responsabilidade, confiabilidade e também indica que você de fato entende sobre o assunto e está buscando a melhor solução para o problema, e não apenas se apegando a sua ideia preferida.
